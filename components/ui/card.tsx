...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "rounded-xl border border-white/10 bg-card text-card-foreground shadow-xl backdrop-blur-md relative overflow-hidden",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-semibold leading-none tracking-tight font-display text-primary uppercase italic",
        className,
      )}
      {...props}
    />
