  ...
  return (
    <Card className="w-full max-w-md border-primary/20 bg-black/40 backdrop-blur-xl animate-in fade-in zoom-in duration-500">
      <CardHeader className="text-center space-y-4 relative overflow-hidden">
        ...
        <div className="inline-flex items-center justify-center w-24 h-24 bg-linear-to-br from-primary/20 to-transparent rounded-full mb-4 mx-auto border border-primary/30 shadow-[0_0_15px_rgba(0,0,0,0.5)] shadow-primary/10 backdrop-blur-sm group">
        ...
        <CardTitle className="text-5xl font-bold text-primary tracking-tighter drop-shadow-sm -skew-x-10">
          IMPOSTOR <br />{" "}
          <span className="text-white text-3xl tracking-normal font-sans font-light not-italic block mt-1 skew-x-10">
            FUTBOLERO
          </span>
        </CardTitle>
        <CardDescription className="text-lg font-medium text-muted-foreground">
          ¿Quién es el{" "}
          <span className="text-accent underline decoration-wavy underline-offset-4 pointer-events-none">
            impostor
          </span>
          ?
        </CardDescription>
        ...
        <div className="pt-6 border-t border-white/5">
          ...
          <ul className="text-xs text-muted-foreground space-y-2 font-mono bg-black/20 p-4 rounded-lg border border-white/5">
            <li className="flex items-start gap-2">
              ...
              <span>
                Un jugador será el <strong>impostor</strong>.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
